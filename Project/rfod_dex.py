...
if dataset_name == "thyroid":
    ...
    bb_train_path = os.path.join(base_dir, "Datasets/Backblaze/train_set.csv")
    bb_val_path = os.path.join(base_dir, "Datasets/Backblaze/val_set.csv")
    bb_val_ids_path = os.path.join(base_dir, "Datasets/Backblaze/val_serial_number_id.csv")
    bb_val_labels_path = os.path.join(base_dir, "Datasets/Backblaze/val_label.csv")
    ...
    _orig_val_df = _bb_val.copy().reset_index(drop=True)
